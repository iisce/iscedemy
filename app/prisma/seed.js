...
async function seed() {
     ...
     //       update: {},
     //       create: {
     //            id: "awareness-program-2025",
     //            title: "AI Awareness Program 2025",
     //            description:
     //                 "Join industry experts to future-proof your career with AI",
     //            price: 5000,
     //            date: new Date("2025-08-30T10:00:00+01:00"),
     //       },
     //  });
     //  console.log(`${event.count} Seeded Event: awareness-program-2025`);
     /** FOR TEST DB */
     // const certificate = await prisma.certificate.createMany({
     //     data:[
     //         {
