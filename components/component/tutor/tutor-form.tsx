               ...
               BecomeTutor(values)
                    .then((data) => {
                         if (data?.error) {
                              ...
                              setSuccess("You've successfully applied!");
                              router.push("/");
                         }
                    })
                    .catch((error) => {
                         console.error(
                              "Error registering tutor. Please try",
                              error,
                         );
                    });
          });
               ...
               <MaxWidthWrapper>
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                         <div className="flex items-center justify-center">
                              <h1 className="text-left text-3xl font-bold leading-tight md:text-7xl md:leading-none xl:text-8xl">
                         ...
                         <div className="">
                              <Form {...form}>
                                   <form
                                        className="w-full px-3 py-3 shadow-lg outline-2"
                                                                 ...
                                                                 <FormItem>
                                                                      ...
                                                                      <FormControl>
                                                                           <Textarea
                                                                                ...
                                                                                className="h-40 w-full p-3 shadow-lg"
