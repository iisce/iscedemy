...
const EditCourseForm: React.FC<EditCourseFormProps> = ({
     ...
     const selectedProgramType =
          form.watch("programType") || course.programType;
     ...
     const previewContent = {
          ...
          category:
               form.watch("category") || course.category || "Uncategorized",
          textSnippet:
               form.watch("textSnippet") ||
               course.textSnippet ||
               "No header text provided",
          description:
               form.watch("description") ||
               course.description ||
               "No description provided",
          conclusion:
               form.watch("conclusion") ||
               course.conclusion ||
               "No conclusion provided",
          summary:
               form.watch("summary") || course.summary || "No summary provided",
          overView:
               form.watch("overView") ||
               course.overView ||
          ...
          programType:
               ...
               "CRASH_COURSE",
          duration:
               form.watch("duration") || course.duration || "Not specified",
          noOfClass:
               form.watch("noOfClass") || course.noOfClass || "Not specified",
          classDays:
               form.watch("classDays") || course.classDays || "Not specified",
          certificate: form.watch("certificate")
               ? "Yes"
               : course.certificate
                 ? "Yes"
                 : "No",
          videoUrl:
               form.watch("videoUrl") || course.videoUrl || "No video provided",
