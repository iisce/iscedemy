...
export default function TutorProfile({ tutorName, highestAverageRating }: ITutorProfileProps) {
  ...
  if (!tutor) {
    return <div><FormError message="Tutor profile not available at the moment"/></div>;
  }
	return (
