                         ...
                         <Body className="w-full">
                              <Container className="w-full">
                                   ...
                                   <Section>
                                        ...
                                        <Text>
                                             Someone recently requested for a
                                             password change to your PalmTechnIQ
                                             account. If this was you, tap the
                                             button below to reset your
                                             password.
                                        </Text>
                                   </Section>
                                   ...
                                   <Text>
                                        If you did not request for this please
